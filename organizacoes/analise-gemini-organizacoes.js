...
o texto que você deve ler e analisar vai ser enviado na próxima mensagem. Não considere os exemplos das categorias na sua análise, somente o texto da próxima mensagem que vou te enviar que pode ser texto puro ou um arquivo em pdf.
`.trim();
